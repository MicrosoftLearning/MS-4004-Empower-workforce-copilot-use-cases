...
1. Open a new tab in your Microsoft Edge browser and then open the **Microsoft 365 Copilot** home page.

2. In **Microsoft 365 Copilot**, select **New agent** in the navigation pane. Doing so opens Copilot Studio's **Agent Builder** and displays the **New agent** page.
...
7. Review Copilot’s response after updating the instructions. To verify the changes that Copilot made, select the **Configure** tab and then scroll down to the **Instructions** section. Verify that Copilot added the new instructions that you requested.
...
10. Once Copilot responds that it updated the instructions, select the **Configure** tab and scroll through the **Instructions** section. Note the new items that Copilot added.
