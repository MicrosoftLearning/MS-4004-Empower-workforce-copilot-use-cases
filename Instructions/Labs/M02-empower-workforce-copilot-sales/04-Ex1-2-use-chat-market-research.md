...
1. Since the Researcher agent is running in your current Microsoft Edge browser tab, open a new tab and then open **Microsoft 365 Copilot**.

2. In the **Microsoft 365 Copilot** home page, select the **Web** option, which is used for retrieving external information from public sources like blogs and websites. Leave the response mode selector set to **Auto**.
