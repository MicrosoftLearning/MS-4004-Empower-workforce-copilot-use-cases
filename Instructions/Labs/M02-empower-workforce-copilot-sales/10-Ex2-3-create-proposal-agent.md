...
6. After you enter a description and select the **Send** button, the **Agent Builder** form should appear for your new agent. The **Agent Builder** chat pane appears on the left, and the agent details appear on the right. At the top of the form are a **Configure** tab and a **Preview** tab.
    ...
    Wait a minute or two for Copilot to create the agent, at which time it displays the agent's name and description in the **Agent Builder** pane.
...
15. In the **Knowledge** section, select the **+ Add knowledge**, and then select **Attach cloud files** (cloud icon). In the **Pick items** window that appears, locate and select the **EcoSense360-RFP-Documents** folder. Select all files in this folder and then select the **Select** button.

16. Scroll to the bottom of the **Knowledge** section and confirm that the files from the **EcoSense360-RFP-Documents** folder are listed.
...
20. You now want to add a final suggested prompt that asks the agent to generate an RFP document based on an attached sales proposal file.
   ...
   If Copilot didn't already generate this suggested prompt, add it manually:  
