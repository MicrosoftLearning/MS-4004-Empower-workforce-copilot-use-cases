...
1. In **Microsoft Copilot**, select the **App Launcher** (grid icon) in the top left corner of the page, and then select **More Apps**. In the **All apps→** window, scroll down and select **Whiteboard**. 
