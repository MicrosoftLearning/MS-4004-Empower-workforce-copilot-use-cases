---
lab:
  title: 'Exercise 2, Task 1: Use Microsoft Copilot to identify upcoming Microsoft 365 features'
...
5. When editing in **Pages**, note how Microsoft Copilot displays the Copilot chat pane along with the **Pages** form. In the **Pages** form, select the ellipsis **(...)** button and then select **Export** > **Document** from the drop-down menu. In the dialog box that appears, select **Open Word**, which opens the document in **Word for the web**. 
...
7. In the bottom-right corner of the Word document, select the **Copilot** icon to open the Copilot pane. Verify the pane opens in edit mode—the heading should read **Let's edit your document**. Below the heading, confirm that the mode selector is set to **Allow editing** (so Copilot can edit your document directly). If it shows **Chat only**, select the drop-down and then select **Allow editing**.
...
9. In the **Copilot** pane, ask Copilot to add a short executive summary based on the content in the document. 
