---
lab:
  title: 'Exercise 2, Task 1: Use Microsoft 365 Copilot Chat to identify upcoming Microsoft 365 features'
...
4.  At the end of the response, select the **Copy response** icon.

5.  In the **Microsoft 365 Copilot Chat** window, select the **Apps** icon in the navigation pane. In the **Apps** menu that appears, select **Word**.
