...
---
Now that you've completed your marketing research and analysis, you're ready to launch Relecloud's WorkSpace 360 smart workplace solution in the commercial office market. To do so, you must create a fully integrated launch campaign plan that brings the marketing strategies to life and drives measurable results.
...
1. In your web browser, go to the **Microsoft Copilot** home page, select the **App Launcher** (grid icon), and then select **More Apps**. From the list of apps, select **Loop**.

2. In **Loop for the web**, select **+ Create new**, then select **New workspace** to create a new workspace. For the workspace name, enter `WorkSpace 360 Launch Campaign Plan`. Select the **Create** button.
...
3. You plan to create the following pages under this Loop workspace (in this order):
    ...
    To begin, change the current title of the first page from **Untitled** to **Campaign objectives**.

4. At the top of the page, select the **Copilot** icon to open the **Copilot** pane for this page.

5. Ask Copilot to review the attached **Market Insights Report – Smart Workspaces.docx** file and identify the primary goals for this campaign (for example, awareness, engagement, lead generation). Translate these goals into SMART objectives (Specific, Measurable, Achievable, Relevant, Time-bound). For example, "Increase LinkedIn engagement by 30% in 90 days." Select the **+** icon in the prompt field and attach the **Smart Workspace Market Insights.docx** file.
...
7. Create the remaining pages listed in step 3. On each page, open the **Copilot** pane, attach the **Smart Workspace Market Insights.docx** file, and use the relevant prompt below. Include instructions in the prompt to generate the requested information based on the market research in the file. Review Copilot's response, copy it to the page, and remove any extraneous copied text.
