...
lab:
  ...
  description: In the previous phase, you used the Market Research Agent to collect
    and synthesize comprehensive insights on the smart workspace products market.
    You saved this information in a report titled **Market Insights Report – Smart
    Workspaces.docx**. The data in this report included trends, audience behaviors,
    cultural shifts, competitive developments, and recommended actions. Now, it’s
    time to move from insight to strategy.
  duration: 60 minutes
  level: 100
  islab: true
---
...
17. Once the agent finishes generating the PDF, it opens a new browser tab that contains the PDF. Select the **Save** button that appears at the bottom of the **Print** pane. Save the PDF to your OneDrive as **Smart Workspace opportunities.pdf**.
...
20. Review the results. You want to eventually save this content as a PowerPoint presentation, so select the **Edit in Pages** icon that appears at the end of the content.

21. On the **Pages** pane, select the **Create** button and then select **Presentation** from the menu.

22. Once the agent is ready to create the presentation, select the **Continue** button that appears. Doing so opens a new browser tab that contains a **Create a presentation with Copilot** form in **PowerPoint for the web**. The prompt field should be prefilled with a file containing the **Pages** content and an instruction to create a presentation based on the file. Nothing else is needed, so select the **Send (arrow)** icon.

23. Copilot in PowerPoint should generate an outline of the presentation. At the bottom of the outline, you can optionally select a **Presentation style** if you wish. Then select the **Generate slides** button.
