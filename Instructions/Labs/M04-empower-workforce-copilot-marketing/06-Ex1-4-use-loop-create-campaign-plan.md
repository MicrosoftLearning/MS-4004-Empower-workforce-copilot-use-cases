...
lab:
  ...
  description: Now that you completed your marketing research and analysis, you’re
    ready to launch Relecloud’s WorkSpace 360 smart workplace solution in the commercial
    office market. To do so, you must begin by creating a fully integrated launch
    campaign plan that brings the marketing strategies to life and drives measurable
    results.
  duration: 24 minutes
  level: 100
  islab: true
...
2.  In **Loop for the web**, create a new workspace titled **WorkSpace 360 Launch Campaign Plan**.
...
5.  Ask Copilot to review the attached **Smart Workspace Market Insights.docx** file and identify the primary goals for this campaign (for example, awareness, engagement, lead generation). Translate these goals into SMART objectives (Specific, Measurable, Achievable, Relevant, Time-bound). For example, “Increase LinkedIn engagement by 30% in 90 days.” Select the plus sign (+) icon in the prompt field and attach the **Smart Workspace Market Insights.docx** file.
...
7.  Repeat the previous steps to add the remaining pages defined in step 3. For each page, attach the **Smart Workspace Market Insights.docx** file to the Copilot prompt and ask Copilot to generate the following information based on the market research in the file (copy and paste this bulleted list into your prompt, then copy this prompt to reuse it for each new page request):  
