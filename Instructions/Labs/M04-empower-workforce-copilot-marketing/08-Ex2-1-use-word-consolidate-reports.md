...
6. In the Copilot prompt field, select the plus **(+)** sign, and then select **Add cloud files** in the drop-down menu. Attach the three market report documents that you downloaded in Step 1.
...
13. Review the new Distribution Channels section. If you want to make any manual changes, you can do so now. Also, review Copilot's suggested prompts at the end of the Copilot pane. Feel free to implement any of Copilot's suggestions if you want. 

14. When you are satisfied with the document, select **Done**, save the report to your OneDrive folder as **LATAM Market Analysis report**, and then close it.
