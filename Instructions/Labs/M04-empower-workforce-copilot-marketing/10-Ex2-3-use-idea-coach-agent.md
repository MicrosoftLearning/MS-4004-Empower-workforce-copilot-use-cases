---
lab:
  title: 'Exercise 2, Task 3: Use Copilot’s Idea Coach agent to generate creative campaign concepts'
...
1. Open **Microsoft 365 Copilot** and in the navigation pane, select **Agents**. In the **Agent Store**, under the **Your agents** section, select **See more**. In the expanded list of **Your agents**, select **Idea Coach**.
...
5. Your ultimate goal is to create a Word document that contains not only this response, but various other ideas that you're going to ask Idea Coach to generate regarding your selected campaign in the upcoming steps. While creating documents is outside the role of the Idea Coach, it does provide you with the ability to edit its responses in **Pages**, which can then be saved in a Word document, PowerPoint, or PDF.
    ...
    Since you want to eventually save this content to a Word document, select the ellipsis (...), then select the **Edit in Pages** option that appears at the end of the response.
