...
1.  Open **Microsoft 365** and in the navigation pane, under the **Agents** section, select **All agents**. In the **Agent Store**, under the **Your agents** section, select **See more**. In the expanded list of **Your agents**, select **Writing Coach**.
