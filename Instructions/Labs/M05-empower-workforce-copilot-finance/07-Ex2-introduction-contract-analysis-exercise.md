---
lab:
  title: 'Exercise 2: Streamline contract analysis and negotiation using Microsoft 365 Copilot'
  description: Your job is to analyze the terms, identify potential risks, and prepare a concise presentation and email update for the Finance leadership team. You plan to use Microsoft 365 Copilot to streamline your workflow—saving time, uncovering insights, and improving collaboration with colleagues.
  duration: 12 minutes
  level: 200
  islab: true
  primarytopics:
