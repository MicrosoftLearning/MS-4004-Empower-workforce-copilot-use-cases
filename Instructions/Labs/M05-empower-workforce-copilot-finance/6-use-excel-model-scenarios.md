...
- Create charts that visualize the impact of these changes.
...
3.  In **Excel for the web**, open the **Relecloud Acquisition Financials** spreadsheet.
...
7.  Review the results and charts. Insert the first chart into a new sheet. Then place your cursor in a cell below the chart and insert the second chart into the same sheet. Repeat for any other charts. Rename the sheet **What-if EBITDA**.
