...
8.  Note how Copilot answered each of your questions. In each case, it didn't insert any of the answers into the current document. While you can insert each answer into the document (either through an **Insert** or **Add to doc** button or by copying the content and pasting it into the document), it seems apparent that having Copilot create the report is more efficient than asking multiple questions in the Copilot pane.
...
9.  While efficiency is one thing, the level or quality of information provided by each method is another. How does the level of information for each reporting method compare to one another? Compare the level of information provided when Copilot in Word created a report versus the answers it provided when you asked the questions individually in the Copilot pane. What did you notice?  
    <br/>When you ask Copilot to create a report, it usually provides richer responses that it organizes into an attractive looking report. Conversely, when you ask Copilot to answer questions individually in the Copilot pane, it doesn't return the level of detail as the report. Although the Copilot pane does allow you to insert the responses into a document, it doesn’t automatically create headings or sections. The key thing to remember about using the Copilot pane is that it’s designed to supplement content in an existing document. 
