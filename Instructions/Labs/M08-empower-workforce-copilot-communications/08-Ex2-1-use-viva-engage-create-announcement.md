...
1. In your Microsoft Edge browser, sign in to the **Microsoft 365 Copilot** home page [**https://m365.cloud.microsoft.com**](https://m365.cloud.microsoft.com) and select the **App Launcher** (grid icon), select **More Apps**, and then select **Engage** from the list of available apps.
...
3. In the **Create a new community** window, enter **TR-Pulse testing** in the **Name** field, and enter **This community is used for testing the Viva Engage announcement for TR-Pulse** in the **Description** field. Select the **Create** button.
...
6. Copy and paste the following prompt that asks Copilot to draft a Viva Engage announcement highlighting the rollout of TR-Pulse:
...
16. In the **TR-Pulse testing** community, you should see the post that Copilot just created for you.
