...
3. In **Microsoft 365 Copilot**, select **Agents** in the navigation pane and then select **Create agent**. Doing so opens Copilot Studio's **Agent Builder** and displays the **New agent** page.
...
14. In the **Knowledge** section, select the **+ Add knowledge** button, and then select the **Upload from device** icon on the top right. In the **File Explorer** window that appears, select the three files that you downloaded in Step 1.
