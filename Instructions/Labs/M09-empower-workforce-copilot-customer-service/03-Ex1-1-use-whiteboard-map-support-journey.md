...
1. In your Microsoft Edge browser, sign in to the **Microsoft 365 Copilot** home page at [**https://m365.cloud.microsoft.com**](https://m365.cloud.microsoft.com).

2. In the **Microsoft 365 Copilot Chat** window, select the **App Launcher** (grid icon), and then select **More Apps**. Under the top section of apps in the **Apps** window, select **All apps→**. In the **All apps** window, scroll down and select **Whiteboard**.
