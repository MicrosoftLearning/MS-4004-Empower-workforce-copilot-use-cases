...
3.  In **Whiteboard for the web**, start a new Whiteboard session.

4.  The **Board name** for this session defaults to **Whiteboard X** (where X is a number). Select this field and change the **Board name** to **Lamna’s ideal clinic support case workflow.**
