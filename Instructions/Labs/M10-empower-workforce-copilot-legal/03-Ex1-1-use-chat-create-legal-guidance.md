...
2. Since you want Copilot Chat to access web content for the CCPA and CPRA, select the **Web** toggle switch. Leave the response mode selector set to **Auto**.

3.  Ask Copilot to outline the key provisions of the CCPA and CPRA acts.
