...
2. In **Microsoft 365 Copilot**, select **Agents** in the navigation pane and then select **Create agent**. Doing so opens Copilot Studio's **Agent Builder** and displays the **New agent** page.
